...
* added more the dimensional views of the MDS plot and PCA plot (Dim1 vs Dim2, Dim2 vs Dim3, Dim1 vs Dim3)
* added the comparisons of interaction of genotype and treatment among DJ, D, and J groups  (a4, a5, a6)
...
```{r dispersion, results='hide', fig.width=7, fig.height=7, out.width="3.5in", fig.align="center", fig.path="../figure/"}
## ----design--------------------------------------------------------------
...
3. Pathway analysis
  ...
  * I can also help to analyze the gene set using Ingenuity Pathway Analysis (IPA) looking for gene network, transcrpition factor network etc, if you have interested comparisons.  
...
```{r heatmap, fig.width=8, fig.height=12, out.width="5in", fig.cap="heat map across all the samples using the top 100 most DE genes between CONC and DNT groups of all genotypes" }
## ----MakeContrasts--------------------------------------------------------------
con <- makeContrasts(
  a1_DJvsC = (Ddit3_Jun.CONC - Ddit3_Jun.DNT) - (Control.CONC - Control.DNT),
  a2_JvsC = (Jun.CONC - Jun.DNT) - (Control.CONC - Control.DNT),
